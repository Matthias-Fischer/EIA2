...
window.onload = function () {
    ...
    // Hierf�r wird eine neue Variable namens "divList" einegf�hrt, 
    // die mit der Schleife explizit diese ersten 8 Felder ansprechen
    // Au�erdem sind diese Felder nun klickbar
    // Der Begriff toggle bedeutet "umschalten". Bei jedem Klick auf ein Feld der ersten Reihe des Schachbretts 
    // sch�lt das Programm zwischen der Klasse "selected" und der normalen darstellung hin und her
    // Laut w3schools : to toggle between hiding and showing elements with class="markiert".  
    // Au�erdem soll jetzt die Funktion zur Berechnung der Summe der Reisk�rner aufgerufen werden
    ...
    // Zur Berechnung der K�rner-Summe wird nun eine Funktion eingef�hrt
    function berechneSummeKoerner() {
        // F�r die nachfolgende If-Abfrage werden 2 neue Variablen erstellt
        var markierteDivs = document.getElementsByClassName("markiert");
        var summeKoerner = 0;
        // Ist keines der 8 Felder der ersten Reihe ausgew�hlt, soll das DIV, welches sich an dem Mauszeiger befindet
        ...
        // Hierf�r wird erneut eine neue Variable eingef�hrt, um diese mit Hilfe einer For-Schleife mit den markierten DIVs zu vergleichen
